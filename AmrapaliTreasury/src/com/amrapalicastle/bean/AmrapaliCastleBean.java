package com.amrapalicastle.bean;

public class AmrapaliCastleBean {
...
private String feePerSqrFeet;
private String fromMonth;
private String toMonth;
private String copyAmount;
private String currentMonthNo;
public String getCurrentMonthNo() {
	return currentMonthNo;
}
public void setCurrentMonthNo(String currentMonthNo) {
...
public String getFeePerSqrFeet() {
	return feePerSqrFeet;
}
public void setFeePerSqrFeet(String feePerSqrFeet) {
	this.feePerSqrFeet = feePerSqrFeet;
}
...
public String getPaymentDueFlag() {
	return paymentDueFlag;
}
public void setPaymentDueFlag(String paymentDueFlag) {
	this.paymentDueFlag = paymentDueFlag;
}
